...
// Question Number 3-----------------------------------
// Event Deligated Add and remove Value
...
const startColorChange = document.getElementById("startColorChange");
...
let colorChangerInterId;

startColorChange.addEventListener("click", () => {
  colorChangerInterId = setInterval(() => {
...
const paraToChangeWithNewOne = document.getElementById(
  "paraToChangeWithNewOne"
);
...
const itemContainerToAddItems = document.getElementById(
  "itemContainerToAddItems"
);
const addItemButtonInContainer = document.getElementById(
  "addItemButtonInContainer"
);
let itemCount = 0;
...
const toggleContainerHideAndSeak = document.getElementById(
  "toggleContainerHideAndSeak"
);
const hideToggleContainerHideAndSeak = document.getElementById(
  "hideToggleContainerHideAndSeak"
);
const showToggleContainerHideAndSeak = document.getElementById(
  "showToggleContainerHideAndSeak"
);
...
colorChangin15.forEach((element) => {
  element.addEventListener("click", (event) => {
    console.log(event.target.textContent);
    colorChangerBoxFor15.style.backgroundColor =
